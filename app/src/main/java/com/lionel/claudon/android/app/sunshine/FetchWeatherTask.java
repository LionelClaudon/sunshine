...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = mContext.getContentResolver().query(LocationEntry.CONTENT_URI,new String[]{LocationEntry._ID},
        ...
        if(cursor.moveToFirst()) {
            ...
            newValue.put(LocationEntry.COLUMN_LOCATION_SETTING, locationSetting);
            newValue.put(LocationEntry.COLUMN_CITY_NAME, cityName);
            newValue.put(LocationEntry.COLUMN_COORD_LAT, lat);
            newValue.put(LocationEntry.COLUMN_COORD_LONG, lon);

            Uri uri = mContext.getContentResolver().insert(LocationEntry.CONTENT_URI, newValue);
